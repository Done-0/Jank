...
// @Param		children	body	[]GetOneCategoryVo	true	"子类目列表"
type GetOneCategoryVo struct {
	...
	Children    []*GetOneCategoryVo `json:"children" xml:"children" form:"children" query:"children"`
}
