...
type RegisterRequest struct {
	...
	Phone                 string `json:"phone" xml:"phone" form:"phone" query:"phone" validate:"required,phone"`
	Nickname              string `json:"nickname" xml:"nickname" form:"nickname" query:"nickname" validate:"required,min=1"`
	Password              string `json:"password" xml:"password" form:"password" query:"password" validate:"required,min=6"`
