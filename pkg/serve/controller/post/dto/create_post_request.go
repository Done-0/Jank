...
//	@Param	content_markdown	body	string	true	"文章内容(markdown格式)"
...
type CreateOnePostRequest struct {
	...
	ContentMarkdown string  `json:"content_markdown" xml:"content_markdown" form:"content_markdown" query:"content_markdown" validate:"required"`
